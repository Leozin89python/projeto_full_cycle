...
class UuidFactory implements UuidFactoryInterface
{
    ...
    /**
     * Constructs a `UuidFactory` for creating `Ramsey\Uud\UuidInterface` instances
     *
    ...
    /**
     * Returns the UUID builder this factory uses when creating `Uud` instances
     *
    ...
    /**
     * Sets the UUID builder this factory will use when creating `Uud` instances
     *
     ...
     * value UUID fields to construct a `Uud` object.
     *
    ...
    /**
     * Returns a version 3 or 5 namespaced `Uud`
     *
    ...
    /**
     * Returns a `Uud` created from `$hash` with the version field set to `$version`
